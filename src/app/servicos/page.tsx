          ...
          <article className={`flex justify-center`}>
            ...
            <div className={`flex flex-col items-center gap-1.5 bg-[#F2B705] w-5/12 h-max px-6 pt-5 pb-6 rounded-e-4xl space-y-5 shadow`}>
              ...
              <a
                ...
                className={`bg-[#C522F2] text-[#FCFAFF] text-2xl text-shadow-2xs font-semibold px-8 py-4 rounded-full shadow transition hover:bg-[#6C0CF2] active:bg-[#FCFAFF] active:text-[#252228]`}
              >
                Encomendar Desenho
              </a>
            </div>
          ...
          <div className={`flex justify-center gap-20 w-full`}>
              ...
              <table className="border-separate border-spacing-0 text-center w-full">
                ...
                <tbody>
                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Humanos</td>
                  </tr>

                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Animais/Pokémon e cia</td>
                  </tr>

                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Furry</td>
                  </tr>

                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Seres Mitológicos/Mágicos</td>
                  </tr>

                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Aliens</td>
                  </tr>

                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Robôs humanoides e zoomórficos</td>
                  </tr>

                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Fanarts/OCs/Personagens de RPG</td>
                  </tr>

                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Familiares e Pets</td>
                  </tr>
                </tbody>
              </table>
            </article>
            ...
            <article className="overflow-hidden rounded-4xl border-2 border-[#6C0CF2] w-full h-max shadow">
              <table className="border-separate border-spacing-0 text-center w-full">
                ...
                <tbody>
                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Gore</td>
                  </tr>

                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Veículo/meccha</td>
                  </tr>

                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Mensagens de ódio</td>
                  </tr>

                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Personagens infantis</td>
                  </tr>

                  <tr className="bg-[#FCFAFF]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Animais em situações adultas</td>
                  </tr>
                  
                  <tr className="bg-[#F1ACF2]">
                    <td className="text-[#252228] text-2xl text-shadow-2xs py-3 px-4">Quaisquer contextos religiosos reais</td>
                  </tr>
                </tbody>
              </table>
            </article>
